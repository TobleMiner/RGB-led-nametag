...
$EndDescr
$Comp
L led-panel:led-panel-16x16 U?
U 1 1 61A429F9
P 3650 3900
AR Path="/61A429F9" Ref="U?"  Part="1" 
AR Path="/61A41C1D/61A429F9" Ref="U1"  Part="1" 
AR Path="/61C4C20D/61A429F9" Ref="U9"  Part="1" 
AR Path="/61C4C905/61A429F9" Ref="U16"  Part="1" 
F 0 "U16" H 3625 6915 50  0000 C CNN
F 1 "led-panel-16x16" H 3625 6824 50  0000 C CNN
F 2 "led-panel:bga-led-panel-16x16" H 3400 6800 50  0001 C CNN
...
U 61A5C767
F0 "Sheet61A5C766" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 5800 50 
F3 "B" O L 4900 5900 50 
F4 "C" O L 4900 6000 50 
F5 "D" O L 4900 6100 50 
F6 "E" O L 4900 6200 50 
F7 "F" O L 4900 6300 50 
F8 "G" O L 4900 6400 50 
F9 "H" O L 4900 6500 50 
F10 "SIN" I R 5800 5800 50 
F11 "CLK" I R 5800 5900 50 
F12 "LATCH" I R 5800 6000 50 
F13 "~RST" I R 5800 6100 50 
F14 "~OE" I R 5800 6200 50 
F15 "SOUT" O R 5800 6300 50 
$EndSheet
$Sheet
S 4900 4750 900  900 
U 61A68DB0
F0 "sheet61A68DA0" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 4850 50 
F3 "B" O L 4900 4950 50 
F4 "C" O L 4900 5050 50 
F5 "D" O L 4900 5150 50 
F6 "E" O L 4900 5250 50 
F7 "F" O L 4900 5350 50 
F8 "G" O L 4900 5450 50 
F9 "H" O L 4900 5550 50 
F10 "SIN" I R 5800 4850 50 
F11 "CLK" I R 5800 4950 50 
F12 "LATCH" I R 5800 5050 50 
F13 "~RST" I R 5800 5150 50 
F14 "~OE" I R 5800 5250 50 
F15 "SOUT" O R 5800 5350 50 
$EndSheet
$Sheet
S 4900 3850 900  900 
U 61A6C361
F0 "sheet61A6C351" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 3950 50 
F3 "B" O L 4900 4050 50 
F4 "C" O L 4900 4150 50 
F5 "D" O L 4900 4250 50 
F6 "E" O L 4900 4350 50 
F7 "F" O L 4900 4450 50 
F8 "G" O L 4900 4550 50 
F9 "H" O L 4900 4650 50 
F10 "SIN" I R 5800 3950 50 
F11 "CLK" I R 5800 4050 50 
F12 "LATCH" I R 5800 4150 50 
F13 "~RST" I R 5800 4250 50 
F14 "~OE" I R 5800 4350 50 
F15 "SOUT" O R 5800 4450 50 
$EndSheet
$Sheet
S 4900 2900 900  900 
U 61A75B5D
F0 "sheet61A75B39" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 3000 50 
F3 "B" O L 4900 3100 50 
F4 "C" O L 4900 3200 50 
F5 "D" O L 4900 3300 50 
F6 "E" O L 4900 3400 50 
F7 "F" O L 4900 3500 50 
F8 "G" O L 4900 3600 50 
F9 "H" O L 4900 3700 50 
F10 "SIN" I R 5800 3000 50 
F11 "CLK" I R 5800 3100 50 
F12 "LATCH" I R 5800 3200 50 
F13 "~RST" I R 5800 3300 50 
F14 "~OE" I R 5800 3400 50 
F15 "SOUT" O R 5800 3500 50 
$EndSheet
$Sheet
S 4900 1950 900  900 
U 61A75B6D
F0 "sheet61A75B3A" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 2050 50 
F3 "B" O L 4900 2150 50 
F4 "C" O L 4900 2250 50 
F5 "D" O L 4900 2350 50 
F6 "E" O L 4900 2450 50 
F7 "F" O L 4900 2550 50 
F8 "G" O L 4900 2650 50 
F9 "H" O L 4900 2750 50 
F10 "SIN" I R 5800 2050 50 
F11 "CLK" I R 5800 2150 50 
F12 "LATCH" I R 5800 2250 50 
F13 "~RST" I R 5800 2350 50 
F14 "~OE" I R 5800 2450 50 
F15 "SOUT" O R 5800 2550 50 
$EndSheet
$Sheet
S 4900 1050 900  900 
U 61A75B93
F0 "sheet61A75B3B" 50
F1 "low-side-driver.sch" 50
F2 "A" O L 4900 1150 50 
F3 "B" O L 4900 1250 50 
F4 "C" O L 4900 1350 50 
F5 "D" O L 4900 1450 50 
F6 "E" O L 4900 1550 50 
F7 "F" O L 4900 1650 50 
F8 "G" O L 4900 1750 50 
F9 "H" O L 4900 1850 50 
F10 "SIN" I R 5800 1150 50 
F11 "CLK" I R 5800 1250 50 
F12 "LATCH" I R 5800 1350 50 
F13 "~RST" I R 5800 1450 50 
F14 "~OE" I R 5800 1550 50 
F15 "SOUT" O R 5800 1650 50 
$EndSheet
Wire Wire Line
	5800 1650 5850 1650
Wire Wire Line
...
SIN_LOW
Text HLabel 6400 1250 2    50   Input ~ 0
CLK_LOW
...
Text HLabel 3150 1150 0    50   Input ~ 0
A1
...
Wire Wire Line
	3150 1650 3200 1650
Text HLabel 3150 1750 0    50   Input ~ 0
A7
Wire Wire Line
	3150 1750 3200 1750
...
Wire Wire Line
	3150 1950 3200 1950
Text HLabel 3150 2050 0    50   Input ~ 0
A10
Wire Wire Line
	3150 2050 3200 2050
